...
//        if(client.hasConnectedApi(LocationServices.API)){
//            Log.d(TAG, "GoogleApiClient-> van LocationServices.API");
//        } else {
//            Log.d(TAG, "GoogleApiClient-> nincs LocationServices.API");
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST && resultCode == RESULT_OK) {
            ...
            if (place == null) {
                ...
                Log.d(TAG,"onActivityResult place-> " + place.toString());
            }
